...
This tech test involved refactoring some legacy code, increasing readability and ease of implementation of an existing application. This tech test was undertaken using JavaScript.
...
* [NUMBER OF TESTS] tests in total were written to ensure the desired output was generated from each class and subclass.
